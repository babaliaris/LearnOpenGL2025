...
void CoordinateSpaces::OnAttach()
{
    ...
    m_shader = new FRGL::Shader(
        "Projects/Sandbox/src/shaders/part_I/CoordinateSpaces.v.glsl",
        "Projects/Sandbox/src/shaders/part_I/CoordinateSpaces.f.glsl"
    );
...
void CoordinateSpaces::OnDetach()
{
    delete m_shader;
    delete m_texture1;
    delete m_texture2;
...
void CoordinateSpaces::OnUpdate(double time)
{
