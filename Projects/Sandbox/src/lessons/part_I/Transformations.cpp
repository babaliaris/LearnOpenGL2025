...
void Transformations::OnAttach()
{
    ...
    m_shader = new FRGL::Shader(
        "Projects/Sandbox/src/shaders/part_I/Transformations.v.glsl",
        "Projects/Sandbox/src/shaders/part_I/Transformations.f.glsl"
    );
...
void Transformations::OnStart()
{
    ...
    model = glm::rotate(model, glm::radians(45.5f), glm::vec3(0.0f, 0.0f, 1.0f));
...
void Transformations::OnUpdate(double time)
{
